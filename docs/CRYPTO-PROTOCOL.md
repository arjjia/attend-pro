...
MVP задаёт TTL QR 30 секунд и допускает до 120 секунд clock skew. Экран
преподавателя автоматически выпускает новый challenge каждые 25 секунд. Portal также
...
- что QR не сфотографировали и не переслали в пределах 30 секунд;
